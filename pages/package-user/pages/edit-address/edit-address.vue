<template>
  <view class="Mall4j container">
    ...
    <view v-if="!isMap" class="input-box">
      <view class="section">
        <text>收件人</text>
        <input placeholder="请输入收件人名字" type="text" maxlength="15" :value="receiver" @input="onReceiverInput" />
      </view>
      <view class="section">
        <text>手机号码</text>
      ...
      <view class="section" @tap="translate">
        ...
        <view v-else class="pca placeholder-text">请选择省市区</view>
      ...
      <view class="section">
        <text>详细地址</text>
        <input class="addr" placeholder="如楼号/单元/门牌号" type="text" :value="addr" maxlength="50" @input="onAddrInput" />
        <view class="arrow add-icon" @tap="selectLoaction">
          <image src="/static/submit-address.png" />
        </view>
      </view>
    </view>
    <!-- end input列表 -->
